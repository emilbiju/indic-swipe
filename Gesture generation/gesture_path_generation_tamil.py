...
data=pd.read_excel('/content/indic-swipe/indic-to-indic-datasets/Tamil.xlsx')
lang = 'Tamil'
char_set = ['ஃ', 'அ', 'ஆ', 'இ', 'ஈ', 'உ', 'ஊ', 'எ', 'ஏ', 'ஐ', 'ஒ', 'ஓ', 'ஔ', 'க', 'ங', 'ச', 'ஜ', 'ஞ', 
            'ட', 'ண', 'த', 'ந', 'ன', 'ப', 'ம', 'ய', 'ர', 'ற', 'ல', 'ள', 'ழ', 'வ', 'ஷ', 'ஸ', 'ஹ', 
...
row_5 = ['N']+char_set[44:47]+['N','N','N','N','N',',','D']
