...
row_2 = ['ক', 'খ', 'গ', 'ঘ', 'ঙ', 'চ', 'ছ', 'জ', 'ঝ', 'ঞ','হ']
row_3 = ['ট', 'ঠ', 'ড', 'ঢ', 'ণ', 'ত', 'থ', 'দ', 'ধ', 'ন', 'ঁ']
row_4 = ['প', 'ফ', 'ব', 'ভ', 'ম', 'য', 'র', 'ল', 'শ', 'ষ', 'স']
row_5 = ['N','হ','ঀ', 'ঁ',	'N','N',',', 'ঽ', '়','্','D'] 
...
for i in range(len(matras)):
    valid_chars_dict[matras[i]] = valid_chars_dict[(row_1)[i+1]]
