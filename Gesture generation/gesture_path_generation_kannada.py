...
row_3 = ['ಟ', 'ಠ', 'ಡ', 'ಢ', 'ಣ', 'ತ', 'ಥ', 'ದ', 'ಧ', 'ನ', 'ಔ']
row_4 = ['ಪ', 'ಫ', 'ಬ', 'ಭ', 'ಮ', 'ಯ', 'ರ', 'ಱ', 'ಲ', 'ಳ', 'ವ']
row_5 = ['N','ಶ', 'ಷ', 'N','N',',','ಸ', 'ಹ','್','ಀ','ಁ']
...
for i in range(len(matras)):
    valid_chars_dict[matras[i]] = valid_chars_dict[(row_1+['ಓ','ಔ'])[i+1]]
...
for i in range(len(matras)):
    char_loc_dict[matras[i]] = char_loc_dict[(row_1+['ಓ','ಔ'])[i+1]]
